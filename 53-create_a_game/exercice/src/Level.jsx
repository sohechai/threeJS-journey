...
export function BlockEnd({ position = [0, 0, 0] }) {
	...
	return (
		<group position={position}>
			...
			<RigidBody type="fixed" colliders="hull" restitution={0.2} position={[0, 0.25, 0]} friction={0} >
	...
	return (
		<group position={position}>
			...
			<RigidBody ref={obstacle} type="kinematicPosition" position={[0, 0.3, 0]} restitution={0.2} friction={0} >
				<mesh geometry={boxGeometry} material={obstacleMaterial} scale={[3.5, 0.3, 0.3]} receiveShadow />
			</RigidBody>
		</ group>
	)
}
...
export function BlockAxe({ position = [0, 0, 0] }) {
	...
	return (
		<group position={position}>
			...
			<RigidBody ref={obstacle} type="kinematicPosition" position={[0, 0.3, 0]} restitution={0.2} friction={0} >
				<mesh geometry={boxGeometry} material={obstacleMaterial} scale={[1.5, 1.5, 0.3]} receiveShadow />
			</RigidBody>
		</ group>
	)
}
